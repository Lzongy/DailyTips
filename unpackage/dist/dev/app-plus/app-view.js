...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'Author:'])
Z([3,'https://lzongy.github.io/lzyBlog.github.io/'])
Z([3,'Lzongy'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'tips'])
Z([3,'../../static/content_icon.png'])
Z([3,'width:20px;height:20px;align-items:center;'])
Z([3,'想记录的内容：'])
Z([3,'__e'])
...
Z(z[4])
Z([[4],[[5],[1,'add']]])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[[5],[1,'add']],[[4],[[5],[1,'$0']]]],[[4],[[5],[1,'index']]]]]]]]]]])
Z([3,'primary'])
Z([3,'记录'])
Z([3,'tipcontent'])
Z([3,'index'])
...
var hMB=_mz(z,'image',['src',1,'style',1],[],e,s,gg)
_(cLB,hMB)
var oNB=_oz(z,3,e,s,gg)
_(cLB,oNB)
_(fKB,cLB)
var cOB=_mz(z,'textarea',['bindinput',4,'data-event-opts',1,'type',2,'value',3],[],e,s,gg)
_(fKB,cOB)
var oPB=_n('text')
_rz(z,oPB,'class',8,e,s,gg)
var lQB=_mz(z,'image',['src',9,'style',1],[],e,s,gg)
_(oPB,lQB)
var aRB=_oz(z,11,e,s,gg)
_(oPB,aRB)
_(fKB,oPB)
var tSB=_mz(z,'input',['bindinput',12,'data-event-opts',1,'type',2,'value',3],[],e,s,gg)
_(fKB,tSB)
var eTB=_n('text')
_rz(z,eTB,'class',16,e,s,gg)
var bUB=_mz(z,'image',['src',17,'style',1],[],e,s,gg)
_(eTB,bUB)
var oVB=_oz(z,19,e,s,gg)
_(eTB,oVB)
_(fKB,eTB)
var xWB=_mz(z,'input',['bindinput',20,'data-event-opts',1,'type',2,'value',3],[],e,s,gg)
_(fKB,xWB)
var oXB=_mz(z,'button',['bindtap',24,'class',1,'data-event-opts',2,'type',3],[],e,s,gg)
...
var t7B=_mz(z,'uni-card',['bind:__l',34,'class',1,'extra',2,'mode',3,'note',4,'thumbnail',5,'title',6,'vueId',7,'vueSlots',8],[],o4B,c3B,gg)
var e8B=_oz(z,43,o4B,c3B,gg)
_(t7B,e8B)
var b9B=_n('view')
var o0B=_mz(z,'button',['bindtap',44,'class',1,'data-event-opts',2,'type',3],[],o4B,c3B,gg)
var xAC=_oz(z,48,o4B,c3B,gg)
_(o0B,xAC)
_(b9B,o0B)
_(t7B,b9B)
_(l5B,t7B)
...
h1B.wxXCkey=4
_2z(z,32,o2B,e,s,gg,h1B,'item','index','index')
var oBC=_n('view')
...
var css_id;
var info = info || {};
var _C= [[[2,1],],["body{ background: #BCD2EE; }\n",],];
